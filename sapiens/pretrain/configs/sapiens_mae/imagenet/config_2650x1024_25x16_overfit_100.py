...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/dados/hendrix/customDataRet100', # <--- Certifique-se que suas 10 imagens estão aqui
...
optim_wrapper = dict(
    optimizer=dict(
        type='AdamW',
        lr=8e-5, # Valor estável para batch pequeno
        betas=(0.9, 0.95),
        weight_decay=0.05),
...
param_scheduler = [
    ...
    dict(
        ...
        T_max=17985, 
        by_epoch=True,
        begin=15,    # Começa logo após o warmup
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='0-100files_2650x1024_pixels_patch_25x16_lr8e-5_batch10' 
            )
        )
    ]
)
